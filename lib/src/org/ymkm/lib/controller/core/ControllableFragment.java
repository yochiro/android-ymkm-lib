 ...
 * 
 */
public interface ControllableFragment extends MessageCallback {
	...
	/**
	 * Returns an instance of the {@link ControllableFragmentCallback} that can
	 * process messages recognized by this fragment
	 * 
	 * @return the callback, or {@code null} in case of failure
	 */
	ControllableFragmentCallback getCallback();
	 ...
	 * <p>
	 * A {@link ControllableFragment} can only communicate with the
	...
	/**
	 * Returns the handler associated with this {@link ControllableFragment}
	 * 
	 * @return the Handler
	 */
	Handler getHandler();
